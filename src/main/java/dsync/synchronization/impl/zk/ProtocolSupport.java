...
class ProtocolSupport {
    ...
    public ProtocolSupport(ZooKeeper zookeeper, List<ACL> acl) {
     ...
     * @param path
     */
    protected void ensurePathExists(String path) throws UnknownHostException {
    ...
    protected void ensureExists(final String path, final byte[] data,
            final List<ACL> acl, final CreateMode flags) throws UnknownHostException {
        try {
